...
vlog -vlog01compat -work work +incdir+E:/FPGA/GIT/FPGA/week6_8.17/day_4/sim {E:/FPGA/GIT/FPGA/week6_8.17/day_4/sim/test_dump3.v}

vsim -c -t 1ps -L altera_mf_ver -L altera_ver -L lpm_ver -L sgate_ver -L altera_lnsim_ver -L cycloneive_ver -L work -voptargs="+acc" test_dump3
